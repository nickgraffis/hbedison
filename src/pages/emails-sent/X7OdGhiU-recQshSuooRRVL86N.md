...
[view this email in the browser](https://edisonwp.com/emails-sent/X7OdGhiU-recQshSuooRRVL86N)
...
**ParentEmails:** amberbaltzer@gmail.com

If you would like to add, remove, or update an email from an "_Athlete_" to a _"Parent"_ email, you can do so [here](https://edisonwp.com/email-list/recQshSuooRRVL86N).
...
Micah Baltzer, you are in the **Gold Group**.
...
If you want to change the T-Shirt/Polo Shirt Size you can do so [here](https://edisonwp.com/shirt-size/recQshSuooRRVL86N).
