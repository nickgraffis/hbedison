...
[view this email in the browser](https://edisonwp.com/emails-sent/X7OdGhiU-recQJ1aYxtF0WleKU)
...
**Athlete Emails**: graydensmom@yahoo.com



If you would like to add, remove, or update an email from an "_Athlete_" to a _"Parent"_ email, you can do so [here](https://edisonwp.com/email-list/recQJ1aYxtF0WleKU).
...
Grayden Scott, you are in the **Green Group**.
...
If you want to change the T-Shirt/Polo Shirt Size you can do so [here](https://edisonwp.com/shirt-size/recQJ1aYxtF0WleKU).
