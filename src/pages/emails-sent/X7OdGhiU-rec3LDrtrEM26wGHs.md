...
[view this email in the browser](https://edisonwp.com/emails-sent/X7OdGhiU-rec3LDrtrEM26wGHs)
...
**Athlete Emails**: Dilts.sue@yahoo.com



If you would like to add, remove, or update an email from an "_Athlete_" to a _"Parent"_ email, you can do so [here](https://edisonwp.com/email-list/rec3LDrtrEM26wGHs).
...
Colter Dilts, you are in the **Gold Group**.
...
If you want to change the T-Shirt/Polo Shirt Size you can do so [here](https://edisonwp.com/shirt-size/rec3LDrtrEM26wGHs).
