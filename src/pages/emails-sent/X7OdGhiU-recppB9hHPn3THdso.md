...
[view this email in the browser](https://edisonwp.com/emails-sent/X7OdGhiU-recppB9hHPn3THdso)
...
**Athlete Emails**: ccosby@socal.rr.com

**ParentEmails:** ann.cosby@rsmus.com

If you would like to add, remove, or update an email from an "_Athlete_" to a _"Parent"_ email, you can do so [here](https://edisonwp.com/email-list/recppB9hHPn3THdso).
...
Connor Cosby, you are in the **Green Group**.
...
If you want to change the T-Shirt/Polo Shirt Size you can do so [here](https://edisonwp.com/shirt-size/recppB9hHPn3THdso).
