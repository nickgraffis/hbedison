...
[view this email in the browser](https://edisonwp.com/emails-sent/X7OdGhiU-recTnpon0xKMm8ic0)
...
**Athlete Emails**: ktjbennett@gmail.com, impatbennett@gmail.com



If you would like to add, remove, or update an email from an "_Athlete_" to a _"Parent"_ email, you can do so [here](https://edisonwp.com/email-list/recTnpon0xKMm8ic0).
...
Charlie Bennett, you are in the **Gold Group**.
...
If you want to change the T-Shirt/Polo Shirt Size you can do so [here](https://edisonwp.com/shirt-size/recTnpon0xKMm8ic0).
