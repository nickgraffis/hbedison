...
[view this email in the browser](https://edisonwp.com/emails-sent/X7OdGhiU-recVUnDP6L80OFPYE)
...
If you would like to add, remove, or update an email from an "_Athlete_" to a _"Parent"_ email, you can do so [here](https://edisonwp.com/email-list/recVUnDP6L80OFPYE).
...
Kellan Scott, you are in the **Gold Group**.
...
If you want to change the T-Shirt/Polo Shirt Size you can do so [here](https://edisonwp.com/shirt-size/recVUnDP6L80OFPYE).
