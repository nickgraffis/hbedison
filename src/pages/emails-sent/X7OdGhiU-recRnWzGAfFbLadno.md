...
[view this email in the browser](https://edisonwp.com/emails-sent/X7OdGhiU-recRnWzGAfFbLadno)
...
**Athlete Emails**: Dionechap@msn.com, dcb5150@msn.com



If you would like to add, remove, or update an email from an "_Athlete_" to a _"Parent"_ email, you can do so [here](https://edisonwp.com/email-list/recRnWzGAfFbLadno).
...
Luc Chapman, you are in the **Green Group**.
...
If you want to change the T-Shirt/Polo Shirt Size you can do so [here](https://edisonwp.com/shirt-size/recRnWzGAfFbLadno).
