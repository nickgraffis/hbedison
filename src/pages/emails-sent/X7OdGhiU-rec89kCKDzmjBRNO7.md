...
[view this email in the browser](https://edisonwp.com/emails-sent/X7OdGhiU-rec89kCKDzmjBRNO7)
...
**Athlete Emails**: shaun@shauntryan.com



If you would like to add, remove, or update an email from an "_Athlete_" to a _"Parent"_ email, you can do so [here](https://edisonwp.com/email-list/rec89kCKDzmjBRNO7).
...
Tyler Ryan, you are in the **Gold Group**.
...
If you want to change the T-Shirt/Polo Shirt Size you can do so [here](https://edisonwp.com/shirt-size/rec89kCKDzmjBRNO7).
