...
[view this email in the browser](https://edisonwp.com/emails-sent/-yX_8CfG-recSiUiBejcp56lBA)
...
**Athlete Emails**: vanmeter42@gmail.com



If you would like to add, remove, or update an email from an "_Athlete_" to a _"Parent"_ email, you can do so [here](https://edisonwp.com/email-list/recSiUiBejcp56lBA).
...
Hunter Van Meter, you are in the **Green Group**.
...
If you want to change the T-Shirt/Polo Shirt Size you can do so [here](https://edisonwp.com/shirt-size/recSiUiBejcp56lBA).
