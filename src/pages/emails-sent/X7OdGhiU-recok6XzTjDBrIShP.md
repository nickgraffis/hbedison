...
[view this email in the browser](https://edisonwp.com/emails-sent/X7OdGhiU-recok6XzTjDBrIShP)
...
**Athlete Emails**: hbpolojack@gmail.com

**ParentEmails:** toddmcclung96@gmail.com, 
hbrobyn1@gmail.com

If you would like to add, remove, or update an email from an "_Athlete_" to a _"Parent"_ email, you can do so [here](https://edisonwp.com/email-list/recok6XzTjDBrIShP).
...
Jack McClung, you are in the **Green Group**.
...
If you want to change the T-Shirt/Polo Shirt Size you can do so [here](https://edisonwp.com/shirt-size/recok6XzTjDBrIShP).
