...
**Home Campus**: {{ context?.HomeCampus ? '✅' : '❌' }} {{ context?.HomeCampus ? 'You have signed up for ' : 'You have not signed up for'}} Home Campus.

**Physical**: {{ context?.Physical ? '✅' : '❌' }} {{ context?.Physical ? 'You have a valid physical ' : 'You do not have a valid physical'}}. Email Rich Boyce at [rboyce@hbuhsd.edu](mailto:rboyce@hbuhsd.edu) if you have any questions. 
